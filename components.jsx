    ...
    store: {
      storeCols: [
        ...
        { h: "Accessories", route: "accessories", items: [
          ...
          { label:"Hydration & Bottles",go:["accessories",{tab:"bags"}] },
        ...
        { h: "Quick Shop", route: "store", items: [
          ...
          { label:"Lube & Degreaser", go:["store",{search:"Lube"}] },
          { label:"Pumps",            go:["store",{search:"Pumps"}] },
        ]},
      ],
    },
    services: {
